...
func (ap *application) validatePurchase(pc *data.Purchase) error {
	var err error
	...
	// Validate if the account is from the warehouse when account' role isn't Admin and isn't HeadAccount
	...
	_, err = util.FormatRFC3339(pc.ExpectedAt, time.DateTime)
	if err != nil {
